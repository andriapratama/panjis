...
@section('content')
    <div class="pengumuman-new__container">
        <div style="margin-bottom: 20px; display: block;">
            ...
            <input class="pengumuman-new__input-text" type="text" placeholder="Masukkan judul" id="title" onkeyup="handleChangeTitle(this)">
            <div id="error-title"></div>
        </div>

        <div style="margin-bottom: 20px; display: block;">
            <label for="announ">Isi Pengumuman</label>
            <input class="pengumuman-new__input-text" type="text" placeholder="Masukkan isi pengumuman" id="announ" onkeyup="handleChangeAnnoun(this)">
            <div id="error-announ"></div>
        </div>

        <div style="margin-bottom: 20px; display: block;">
            <label for="date">Tanggal</label>
            <input class="pengumuman-new__input-date" type="date" id="date" onchange="handleChangeDate(this)">
