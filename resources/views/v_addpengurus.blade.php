...
<form action="/pengurus/insert" method="POST" enctype="multipart/form-data">
	@csrf
	...
	<div class="content">
		<div class="row">
			<div class="col-sm-6">
				...
				<div class="form-group">
					<label>Nama</label>
					<input name="nama_pengurus" class="form-control @error('nama_pengurus') is-invalid @enderror" value="{{ old('nama_pengurus')}}">
					<div class="text-danger">
						@error('nama_pengurus')
    						{{ $message }}
						@enderror
