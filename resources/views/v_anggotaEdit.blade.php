...
@section('content')
    <div class="anggota-edit__container">
        ...
        <div style="margin-bottom: 20px; display: block;">
            <input class="input-text" type="text" placeholder="Masukkan nama lengkap anggota" id="name" onkeyup="handleChangeName(this)">
            <div id="error-name"></div>
        </div>

        <div style="margin-bottom: 20px; display: block;">
            <input class="input-text" type="text" placeholder="Masukkan alamat anggota" id="address" onkeyup="handleChangeAddress(this)">
            <div id="error-address"></div>
        </div>

        <div style="margin-bottom: 20px; display: block;">
            <input class="input-text" type="number" placeholder="Masukkan no hp anggota" id="phone" onkeyup="handleChangePhone(this)">
