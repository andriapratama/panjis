...
@section('content')
    <div class="notulen-new__container">
        ...
        <div style="margin-bottom: 20px; display: block;">
            ...
            <input class="input-text" type="number" placeholder="Masukkan total kehadiran anggota " id="total" onkeyup="handleChangeTotal(this)">
                    ...
                    el.append(
                        '<div class="notulen-new__group">'+
                            '<div style="margin-bottom: 20px; display: block; width: 90%;">'+
                                ...
                                '<textarea class="input-textarea" id="paragraf'+index+'" placeholder="Masukkan paragraf" data-index="'+index+'" onkeyup="handleChangeParagraf(this)">'+value.content+'</textarea>'+
                    ...
                    el.append(
                        '<div class="notulen-new__group">'+
                            '<div style="margin-bottom: 20px; display: block; width: 90%;">'+
                                ...
                                '<textarea class="input-textarea" id="list'+index+'" placeholder="Masukkan list" data-index="'+index+'" onkeyup="handleChangeList(this)">'+value.content+'</textarea>'+
